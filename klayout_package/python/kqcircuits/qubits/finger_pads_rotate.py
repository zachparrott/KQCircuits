...
class FingerPads(Qubit):
    ...
    def build(self):
        ...
        # add coupler
        coupler_region = self._build_coupler(self.finger_area_length() / 2 + self.finger_width)
    ...
    def get_ground_region(self):
        ...
        # x_mid = finger_area_width / 2 + self.ground_padding
        # x_bottom = self.a / 2 + self.b
        # x_top = self.a / 2 + self.b
        # y_mid = self.finger_area_length() / 2 + self.finger_width
        # y_bottom = y_mid + (self.ground_padding if x_bottom < x_mid else 0.0)
        # y_top = y_mid + (self.ground_padding if x_top < x_mid else 0.0)
        # y_end = y_mid + self.ground_padding
        # y_max = y_end + self.corner_r

        # region_ground = pya.Region([pya.DPolygon([
        #     pya.DPoint(-x_mid , -y_bottom),
        #     pya.DPoint(-x_bottom, -y_bottom),
        #     pya.DPoint(-x_bottom, -y_max),
        #     pya.DPoint(-x_bottom, -y_max),
        #     pya.DPoint(x_bottom, -y_max),
        #     pya.DPoint(x_bottom, -y_bottom),
        #     pya.DPoint(x_mid, -y_bottom),
        #     pya.DPoint(x_mid, y_top),
        #     pya.DPoint(x_top, y_top),
        #     pya.DPoint(x_top, y_top),
        #     pya.DPoint(x_top, y_max),
        #     pya.DPoint(-x_top, y_max),
        #     pya.DPoint(-x_top, y_top),
        #     pya.DPoint(-x_mid, y_top),
        # ]).to_itype(self.layout.dbu)])
        ...
        # self.cut_region(region_ground, x_mid, y_end)
