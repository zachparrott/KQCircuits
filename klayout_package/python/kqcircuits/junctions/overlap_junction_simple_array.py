...
class OverlapSimpleSeries(Junction):
    ...
    finger_width = Param(pdt.TypeDouble, "Width of the finger.", 0.5, unit="μm")
    ...
    pad_to_pad_separation = Param(pdt.TypeDouble, "Pad separation.", 10.0, unit="μm")
    ...
    def _make_squid_junction(self): #, top_corner, b_corner_y, finger_margin=0):
        ...
        finger_under_pts3 = [
            ...
            pya.DPoint( self.finger_width / 2, - self.bridge_gap / 2),
            pya.DPoint( self.finger_width / 2, - self.bridge_gap / 2 - 0.1),
            pya.DPoint(self.taper_width / 2, - self.bridge_gap / 2 - 0.1),
            pya.DPoint(self.taper_width / 2, self.bridge_gap / 2),
            pya.DPoint(- self.taper_width / 2, self.bridge_gap / 2),
            pya.DPoint(- self.taper_width / 2, - self.bridge_gap / 2 - 0.1),
        ]
        ...
        finger_pts = [
            pya.DPoint(- self.finger_width / 2, - self.bridge_gap / 2),
            pya.DPoint( self.finger_width / 2, - self.bridge_gap / 2),
            pya.DPoint( self.finger_width / 2, - self.pad_to_pad_separation / 2 - self.pad_offset - 1),
            pya.DPoint(- self.finger_width / 2, - self.pad_to_pad_separation / 2 - self.pad_offset - 1),           
        ]
        ...
        under_pts = [finger_under_pts3] #, finger_under_pts1, finger_under_pts2, hook_under_pts1, hook_under_pts2]
