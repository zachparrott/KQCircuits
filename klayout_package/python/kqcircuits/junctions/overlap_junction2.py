...
class Overlap2(Junction):
    ...
    def produce_junction(self):
        ...
        tp_shadow_shape = pya.DTrans(0, False, 0, 0) * polygon_with_vsym(
            bp_shadow_pts_left
        )
    ...
    def _make_qubit_junction(self):  # , top_corner, b_corner_y, finger_margin=0):
        ...
        undercut_shapes = [
            pya.DPolygon(pts).to_itype(self.layout.dbu) for pts in under_pts
        ]
    ...
    def _make_squid_junction(self):  # , top_corner, b_corner_y, finger_margin=0):
        ...
        hook_under_pts = [
            ...
            pya.DPoint(
                shift_hook + -self.taper_width / 2 - self.hook_width,
                self.bridge_gap / 2 + self.hook_thickness,
            ),
            pya.DPoint(
                shift_hook + -self.taper_width / 2 - self.hook_width,
        ...
        finger_under_pts3 = [
            pya.DPoint(
                shift_finger - self.finger_width / 2, -self.bridge_gap / 2 - 0.1
            ),
        ...
        under_pts = [
            hook_under_pts,
            finger_under_pts3,
        ]  # , finger_under_pts1, finger_under_pts2, hook_under_pts1, hook_under_pts2]
