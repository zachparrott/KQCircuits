...
class NISTpart352(Chip):
    ...
    def build(self):
        ...
        # top row positioning
        U_coords = [pya.DTrans(2, False, 1550 + 250 + i * 1300, 4150) for i in range(1)]
        # bottom row positioning
        D_coords = [pya.DTrans(0, False, 3650 - 250 + i * 1300, 1050) for i in range(1)]
