...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=['50'], name_brand='NIST', name_chip='T1 PR', name_copy='v3F')

class NISTpart3fast(Chip):
    ...
    def _produce_readout_hangers(self, coupling_lengths):
        ...
        for i,clength in enumerate(coupling_lengths):
            if i % 2:
                name_prefix = "HR_D"
                trans = pya.DTrans(2, True, 1250 + i*650 + 1 * (clength + self.r), 3750)
            else:
                name_prefix = "HR_U"
                trans = pya.DTrans(0, True, 1700 + i*650 + -1 * (clength + self.r), 3750)
    ...
    def build(self):
        ...
        res_lengths2 = [4120.4, 4190.2, 4042.4, 4107.9, 4066.0, 4009.3, 4001.6, 3973.4]
        
        coupling_lengths = [260, 257, 254, 251, 248, 245, 242, 240]
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['300', '48'], coupler_r=0.0, coupler_offset=14.0, 
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['350', '50'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=5, finger_gap=5, finger_gap_end=5, finger_length=60, finger_number=30,
            corner_r=0, with_squid=False, with_tapers=True, 
            island1_taper_width=20, island1_taper_junction_width=20, 
            island2_taper_width=20, island2_taper_junction_width=20, 
        )
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['243', '20'], coupler_r=0.0, coupler_offset=50.0, 
            island1_extent=['814', '120'], island1_r=0.0, island2_extent=['814', '120'], 
            island2_r=0.0, drive_position=['-450', '0'], island_island_gap=20.0,
            _parameters='{"junction_type": "Sim"}', with_squid=False,
            island1_taper_width=0, island1_taper_junction_width=0, 
            island2_taper_width=0, island2_taper_junction_width=0, 
        ...
        FingerPadsJJ, D_coords[1], f"Q_D1", ground_gap=['800', '510'], 
            ground_gap_r=0.0, coupler_extent=['243', '30'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=7, finger_gap=7, finger_gap_end=7, finger_length=57.5, finger_number=26,
            corner_r=0, with_squid=False, with_tapers=True, 
            island1_taper_width=20, island1_taper_junction_width=20, 
            island2_taper_width=20, island2_taper_junction_width=20, 
        )
        ...
        self.insert_cell(
            ...
            ground_gap_r=74.9, coupler_extent=['173', '20'], coupler_r=0.0, coupler_offset=50.0, 
            island1_extent=['1170', '150'], island1_r=74.9, island2_extent=['1170', '150'], 
            island2_r=74.9, drive_position=['-450', '0'], island_island_gap=150.0,
            junction_total_length=20.0, junction_type='Sim', with_squid=False,
            junction_width=0.02, junction_parameters='{"junction_type": "Sim", "junction_width": 0.02, "junction_total_length": 20.0}', 
            island1_taper_width=100, island1_taper_junction_width=100, 
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['212', '30'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=10, finger_gap=10, finger_gap_end=10, finger_length=49, finger_number=26,
            corner_r=0, with_squid=False, with_tapers=True, 
            island1_taper_width=20, island1_taper_junction_width=20, 
            island2_taper_width=20, island2_taper_junction_width=20, 
        )
        ...
        res_params= {
            ...
            'D0': {'len': res_final[4], 'adj': 2405 - 150 + coupling_lengths[4] - rad_adj},
            'D1': {'len': res_final[5], 'adj': 2305 - 150 + coupling_lengths[5] - rad_adj},
            'D2': {'len': res_final[6], 'adj': 2500 - 150 + coupling_lengths[6] - rad_adj},
            'D3': {'len': res_final[7], 'adj': 2305 - 150 + coupling_lengths[7] - rad_adj},
        }
