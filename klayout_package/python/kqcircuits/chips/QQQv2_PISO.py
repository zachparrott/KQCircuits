...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[200,200], name_brand='ISO', name_chip='QQQ', 
...
class ChipQQQv2PISO(Chip):
    ...
    def produce_junctions(self, penguin, **kwargs):
        ...
        for i, trans in enumerate(penguin):
            if i == 1:
                self.insert_cell(junction_cell, trans * pya.DTrans(0, False, self.jj_pos_A[0], self.jj_pos_A[1]), "jj_At")
                self.insert_cell(junction_cell, trans * pya.DTrans(0, False, self.jj_pos_B[0], self.jj_pos_B[1]), "jj_Bt")
                self.insert_cell(junction_cell, trans * pya.DTrans(0, False, self.jj_pos_C[0], self.jj_pos_C[1]), "jj_Ct")
            else:
                self.insert_cell(short_cell, trans * pya.DTrans(0, False, self.jj_pos_A[0], self.jj_pos_A[1]), "jj_Att")
                self.insert_cell(short_cell, trans * pya.DTrans(0, False, self.jj_pos_B[0], self.jj_pos_B[1]), "jj_Btt")
                self.insert_cell(short_cell, trans * pya.DTrans(0, False, self.jj_pos_C[0], self.jj_pos_C[1]), "jj_Ctt")
    ...
    def produce_squid(self, penguin, **kwargs):
        ...
        self.insert_cell(short_cell, penguin[0] * pya.DTrans(0, False, self.jj_pos_SR[0], self.jj_pos_SR[1]), "jj_SRtt")
    ...
    def build(self):
        ...
        qubit_cell = self.layout.create_cell("QQQv2_PISO", Qubit.LIBRARY_NAME)
        self.insert_cell(qubit_cell, pya.DTrans(0, False, 2600, 2600), "QQQv2PISO")
