...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[150,150], name_brand='QQC', name_chip='QQC', 
                     name_mask='', name_copy='')
...
class ChipQQC(Chip):
    ...
    def build(self):
        ...
        # load OAS
        qubit_cell = self.layout.create_cell("QQC_v10_7_2", Qubit.LIBRARY_NAME)
        self.insert_cell(qubit_cell, pya.DTrans(0, False, 2600, 2600), "QQC")
