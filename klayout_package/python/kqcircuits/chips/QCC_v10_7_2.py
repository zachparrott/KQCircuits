...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[150,150], name_brand='QCC', name_chip='QCC', 
                     name_mask='', name_copy='')

class ChipQCC(Chip):
    """C .
    Single junctions adjusted to comply with the double angle style for the array. 
    """
    # parameters to pass to junctions
    # small junctions
    Q_finger_width = Param(pdt.TypeDouble, "Width of the finger.", 0.100, unit="μm")
    Q_bridge_gap = Param(pdt.TypeDouble, "Gap between finger and hook.", 0.100, unit="μm")
    ...
    jA_pos_A = (75, 158.6035) 
    jA_pos_B = (-75, 158.6035)
