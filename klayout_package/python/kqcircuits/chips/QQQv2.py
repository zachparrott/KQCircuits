...
class ChipQQQv2(Chip):
    ...
    def build(self):
        ...
        qubit_cell = self.layout.create_cell("QQQv2_0", Qubit.LIBRARY_NAME)
        self.insert_cell(qubit_cell, pya.DTrans(0, False, 2600, 2600), inst_name="QQQv2")
