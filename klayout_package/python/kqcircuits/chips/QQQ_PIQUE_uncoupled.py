...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[150,150], name_brand='NIST', name_chip='P unc', 
                     name_mask='', name_copy='')
...
# 
    ...
    def build(self):
        ...
        # load OAS
        qubit_cell = self.layout.create_cell("PIQUE_QQQ_uncoupled", Qubit.LIBRARY_NAME)
        ...
        self.insert_cell(testpad1, pya.DTrans(0, False, 3600, 4000), "JJ_test")
        ...
        self.produce_jj_labels((4080, 4000), (4080, 4000))
