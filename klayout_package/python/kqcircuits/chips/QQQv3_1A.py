...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[200,200], name_brand='QQQ', name_chip='QQQ', 
...
class ChipQQQv31A(Chip):
    """QQQv3.1 with only the A qubit."""
    ...
    def build(self):
        ...
        qubit_cell = self.layout.create_cell("QQQv3_1A", Qubit.LIBRARY_NAME)
        ...
        produce_label(self.cell, label="Z.Parrott", location=pya.DPoint(325, 4275), origin=LabelOrigin.TOPLEFT, origin_offset=0, margin=10, 
                      layers=[self.face()["base_metal_gap_wo_grid"]], layer_protection=self.face()["ground_grid_avoidance"], size=50)
