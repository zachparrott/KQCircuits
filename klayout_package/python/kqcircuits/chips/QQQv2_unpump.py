...
@add_parameters_from(Chip,
                     ...
                     name_brand='QQQ', name_chip='QQQUP', 
...
class ChipQQQv2Unpump(Chip):
    ...
    def build(self):
        ...
        qubit_cell = self.layout.create_cell("QQQv2_unpump", Qubit.LIBRARY_NAME)
        self.insert_cell(qubit_cell, pya.DTrans(0, False, 2600, 2600), "QQQv2")
