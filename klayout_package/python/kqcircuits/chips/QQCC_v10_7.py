...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[150,150], name_brand='QQCC', name_chip='QQCC', 
                     name_mask='', name_copy='')

# @add_parameters_from(Junction, "junction_type")
# @add_parameters_from(Junction)

# Do we need these add_parameters? Different junction species work fine without.
# @add_parameters_from(OverlapArray) #, pad_to_pad_separation=70)
# @add_parameters_from(Overlap) #, pad_to_pad_separation=35)
...
class ChipQQCC(Chip):
    ...
    A_bridge_length = Param(pdt.TypeDouble, "Bridge length.", 1.6, unit="μm")
    A_junction_number = Param(pdt.TypeInt, "Number of junctions.", 81)

    # junction positions from Ansys
    jA_pos_A = (80, 165)
    jj_pos_B = (-90.033321, -7.1324865)
    jj_pos_C = (0, -50.0)
    jj_pos_SL = (-5, 225)
    jj_pos_SR = (35, 225)
    small_jj_gap = 35

    jj_pos_Qtest = (3645, 4260)
    ...
    def produce_junctions(self, **kwargs):
        ...
        # test_cell = self.add_element(Overlap, junction_height=40, pad_to_pad_separation=self.small_jj_gap, **kwargs)
    ...
    def produce_array(self, **kwargs):
        array_cell = self.add_element(OverlapArray, pad_to_pad_separation = 70, **kwargs)
    ...
    def build(self):
        ...
        # load OAS
        qubit_cell = self.layout.create_cell("QQCC_v10_7", Qubit.LIBRARY_NAME)
        self.insert_cell(qubit_cell, pya.DTrans(0, False, 2600, 2600), "QQCC")
        ...
        self.insert_cell(testpad1, pya.DTrans(0, False, 3500, 4000), "JJ_test")
        ...
        self.produce_jj_labels((3500, 4000), (4080, 4000), (500, 1000))
