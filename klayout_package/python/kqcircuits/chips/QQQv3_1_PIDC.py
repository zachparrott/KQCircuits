...
@add_parameters_from(Chip,
                     ...
                     frames_dice_width=[200,200], name_brand='QQQ', name_chip='QIDC', 
...
class ChipQQQv31IDC(Chip):
    ...
    def produce_junctions(self, penguin, **kwargs):
        ...
        for i, trans in enumerate(penguin):
            if i == 0:
                self.insert_cell(junction_cell, trans * pya.DTrans(0, False, self.jj_pos_A[0], self.jj_pos_A[1]), "jj_Atest")
                self.insert_cell(junction_cell, trans * pya.DTrans(0, False, self.jj_pos_B[0], self.jj_pos_B[1]), "jj_Btest")
                self.insert_cell(junction_cell, trans * pya.DTrans(0, False, self.jj_pos_C[0], self.jj_pos_C[1]), "jj_Ctest")
            # else:
    ...
    def produce_squid(self, penguin, **kwargs):
        ...
        self.insert_cell(junction_cell, penguin[0] * pya.DTrans(0, False, self.jj_pos_SR[0], self.jj_pos_SR[1]), "jj_Stest")
    ...
    def produce_jj_labels(self, pos1, pos2):
        ...
        produce_label(self.cell, label1, pya.DPoint(pos1[0] + 700, pos1[1] - 50), LabelOrigin.TOPLEFT, 0, 20, 
                      [self.face()["base_metal_gap_wo_grid"]], self.face()["ground_grid_avoidance"], 50)

        produce_label(self.cell, label2, pya.DPoint(pos2[0] + 700, pos2[1] - 50), LabelOrigin.TOPLEFT, 0, 20, 
                      [self.face()["base_metal_gap_wo_grid"]], self.face()["ground_grid_avoidance"], 50)
    ...
    def build(self):
        ...
        qubit_cell = self.layout.create_cell("QQQv3_1_IDC", Qubit.LIBRARY_NAME)
        ...
        self.insert_cell(resolution, pya.DTrans(0, False, 670+3100, 4200-100), "res")

        self.insert_cell(Profilometer, pya.DTrans(0, False, 670 - 112.5 + 3100, 4075 - 100), "pro")
        ...
        self.insert_cell(NISTlogo, pya.DCplxTrans(scaleFactor, 0, False, 650 + 3100, 4400), "logo")

        produce_label(
            self.cell,
            label="Z.Parrott",
            location=pya.DPoint(325 + 3100, 4275),
