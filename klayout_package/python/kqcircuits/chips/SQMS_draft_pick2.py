...
class SQMSp2(Chip):
    ...
    def build(self):
        ...
        self.insert_cell(
            DoublePads, U_coords[0], f"Q_U0", ground_gap=['1236', '700'], 
            ground_gap_r=0.0, coupler_extent=['90.1', '20'], coupler_r=0.0, coupler_offset=50.0, 
            island1_extent=['796', '120'], island1_r=0.0, island2_extent=['796', '120'], 
        ...
        self.insert_cell(
            DoublePads, U_coords[1], f"Q_U1", ground_gap=['1160', '700'], 
            ground_gap_r=0.0, coupler_extent=['64', '20'], coupler_r=0.0, coupler_offset=50.0, 
            island1_extent=['720', '120'], island1_r=0.0, island2_extent=['720', '120'], 
            island2_r=0.0, drive_position=['-450', '0'], island_island_gap=20.0,
            _parameters='{"junction_type": "Sim"}', with_squid=False,
            island1_taper_width=0, island1_taper_junction_width=0, 
            island2_taper_width=0, island2_taper_junction_width=0, 
        ...
        self.insert_cell(
            DoublePads, U_coords[2], f"Q_U2", ground_gap=['1319', '900'], 
            ground_gap_r=0.0, coupler_extent=['54', '20'], coupler_r=0.0, coupler_offset=50.0, 
            island1_extent=['879', '200'], island1_r=0.0, island2_extent=['879', '200'], 
            island2_r=0.0, drive_position=['-450', '0'], island_island_gap=70.0,
            _parameters='{"junction_type": "Sim"}', with_squid=False,
            island1_taper_width=0, island1_taper_junction_width=0, 
            island2_taper_width=0, island2_taper_junction_width=0, 
        )
        ...
        self.insert_cell(
            DoublePads, U_coords[3], f"Q_U3", ground_gap=['1226', '900'], 
            ground_gap_r=0.0, coupler_extent=['30.4', '20'], coupler_r=0.0, coupler_offset=50.0, 
            island1_extent=['789', '200'], island1_r=0.0, island2_extent=['789', '200'], 
            island2_r=0.0, drive_position=['-450', '0'], island_island_gap=70.0,
            _parameters='{"junction_type": "Sim"}', with_squid=False,
            island1_taper_width=0, island1_taper_junction_width=0, 
            island2_taper_width=0, island2_taper_junction_width=0, 
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['162', '30'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=3, finger_gap=3, finger_gap_end=3, finger_length=64.3, finger_number=30,
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['125.4', '30'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=3, finger_gap=3, finger_gap_end=3, finger_length=57.2, finger_number=30,
            corner_r=0, with_squid=False, with_tapers=False,
        )
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['133.9', '30'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=6, finger_gap=6, finger_gap_end=6, finger_length=56.08, finger_number=30,
            corner_r=0, with_squid=False, with_tapers=False,
        )
        ...
        self.insert_cell(
            ...
            ground_gap_r=0.0, coupler_extent=['107.6', '30'], coupler_r=0.0, coupler_offset=20.0, 
            finger_width=6, finger_gap=6, finger_gap_end=6, finger_length=48.9, finger_number=30,
            corner_r=0, with_squid=False, with_tapers=False,
        )
