...
@add_parameters_from(Chip,
                     ...
                     name_brand='QCCS', name_chip='CSUP', 
...
class ChipQCCv2SingleUnpump(Chip):
    """C ."""
    ...
    def produce_array(self, penguin, **kwargs):
        ...
        for i, trans in enumerate(penguin):
            if i == 1:
                ...
                self.insert_cell(short_cell, trans * pya.DTrans(0, False, self.jA_pos_A[0], self.jA_pos_A[1]), "array_Att")
                self.insert_cell(short_cell, trans * pya.DTrans(0, False, self.jA_pos_B[0], self.jA_pos_B[1]), "array_Btt")
    ...
    def build(self):
        ...
        qubit_cell = self.layout.create_cell("QCCv2_unpump", Qubit.LIBRARY_NAME)
