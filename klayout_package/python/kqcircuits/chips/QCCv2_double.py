...
@add_parameters_from(Chip,
                     ...
                     name_brand='QCCD', name_chip='QCCD', 
...
class ChipQCCv2Double(Chip):
    ...
    array_gap = Param(pdt.TypeDouble, "Spacing between JJ arrays.", 4.0, unit="μm")

    # junction positions from Ansys
    jA_pos_A = (70, 158.6035 + 6) 
    jA_pos_B = (-70, 158.6035 + 6)
    ...
    def produce_array(self, penguin, **kwargs):
        ...
        right = pya.DTrans(0, False, (self.A_bridge_length + self.array_gap)/2, 0)
        left = pya.DTrans(0, False, -1*(self.A_bridge_length + self.array_gap)/2, 0)

        self.insert_cell(array_cell, right * pya.DTrans(0, False, 2600 + self.jA_pos_A[0], 2600 + self.jA_pos_A[1]), "array_A")
        self.insert_cell(array_cell, left * pya.DTrans(0, False, 2600 + self.jA_pos_A[0], 2600 + self.jA_pos_A[1]), "array_At")

        self.insert_cell(array_cell, right * pya.DTrans(0, False, 2600 + self.jA_pos_B[0], 2600 + self.jA_pos_B[1]), "array_B")
        self.insert_cell(array_cell, left * pya.DTrans(0, False, 2600 + self.jA_pos_B[0], 2600 + self.jA_pos_B[1]), "array_Bt")
        

        for i, trans in enumerate(penguin):
            if i == 0:
                self.insert_cell(array_cell, right * trans * pya.DTrans(0, False, self.jA_pos_A[0], self.jA_pos_A[1]), "array_As")
                self.insert_cell(array_cell, right * trans * pya.DTrans(0, False, self.jA_pos_B[0], self.jA_pos_B[1]), "array_Bs")
                self.insert_cell(array_cell, left * trans * pya.DTrans(0, False, self.jA_pos_A[0], self.jA_pos_A[1]), "array_ALs")
                self.insert_cell(array_cell, left * trans * pya.DTrans(0, False, self.jA_pos_B[0], self.jA_pos_B[1]), "array_BLs")
            # else:
            #     self.insert_cell(short_cell, right * trans * pya.DTrans(0, False, self.jA_pos_A[0], self.jA_pos_A[1]), "array_A")
            #     self.insert_cell(short_cell, right * trans * pya.DTrans(0, False, self.jA_pos_B[0], self.jA_pos_B[1]), "array_B")
            #     self.insert_cell(short_cell, left * trans * pya.DTrans(0, False, self.jA_pos_A[0], self.jA_pos_A[1]), "array_A")
            #     self.insert_cell(short_cell, left * trans * pya.DTrans(0, False, self.jA_pos_B[0], self.jA_pos_B[1]), "array_B")
